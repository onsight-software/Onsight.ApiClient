...
namespace Onsight.ApiClient.Tests.Extensions
{
    public static class CustomerDtoExtensions
    {
        public static void VerifyCustomerLinks(this CustomerDto dto, long id)
        {
            ...
            Assert.That(dto.Links[2].Href, Is.EqualTo($"http://publicapiv5.onsightapp.com/customers/{id}/groups"));
            Assert.That(dto.Links[2].Rel, Is.EqualTo("groups"));
            Assert.That(dto.Links[3].Href, Is.EqualTo($"http://publicapiv5.onsightapp.com/customers/{id}/users"));
            Assert.That(dto.Links[3].Rel, Is.EqualTo("assignedTo"));
            Assert.That(dto.Links[4].Href, Is.EqualTo($"http://publicapiv5.onsightapp.com/customers/{id}/customfields"));
